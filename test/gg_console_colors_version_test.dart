...
void main() {
  group('gg_console_colors_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_console_colors_version.dart');
